...
* PP-Module: collaborative PP-Module with PAD-L3 for Biometric verification [<<MOD_L3BIO_V1.0,L3PP-Module>>], <date>, Version <version>
...
|PP-Module: collaborative PP-Module with PAD-L3 for Biometric verification [L3PP-Module], <date>, Version <version>
