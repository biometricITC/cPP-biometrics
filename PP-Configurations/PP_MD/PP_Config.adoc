...
This PP-Configuration, <<PP_MDF>> and <<MOD_BIO_V2.0>> are conformant to Common Criteria CC:2022, Release 1 and the Errata and Interpretation, Version 1.1.
