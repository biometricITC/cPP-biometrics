...
* Base-PP: Protection Profile for Mobile Device Fundamentals, <date>, Version 4.0. <<PP_MDF>>
...
This PP-Configuration, <<PP_MDF>> and <<MOD_BIO_V2.1>> are conformant to Common Criteria CC:2022, Release 1 and the Errata and Interpretation, Version 1.1.
...
.2+.^|Vulnerability Assessment (AVA) 
|Vulnerability Survey (AVA_VAN.1)
|Vulnerabiltiy Analysis (AVA_VAN.2) - from L2PP-Module for PAD only
