...
The TOE in cooperation with its environment shall protect itself, its configuration and biometric data during runtime and storage.
...
The TOE shall protect the TOE, the TOE configuration and biometric data using the secure execution environment provided by the TOE environment during runtime and storage.
