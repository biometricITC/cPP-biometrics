...
=== Glossary
For the purpose of this PP-Module, the following terms and definitions given in <<ISOIEC19795-1,ISO/IEC 19795-1>> and <<ISO30107-1,ISO/IEC 30107-1>>. If the same terms and definitions are given in those references, terms and definitions that fit the context of this PP-Module take precedence. Some terms and definitions are also adjusted to match the context of the mobile biometric enrolment and verification.
...
....
    ...
    +--------------------------------------------+  |
    |                                            |  |  +---+
    | FIA_MBV_EXT  Mobile biometric verification +--+->| 2 |
    |                                            |  |  +---+
    +--------------------------------------------+  |
                                                    |  +---+
                                                    +->| 3 |
