...
....
    +---------------------------------------------+ 
    |                                             |     +---+
    | FIA_PAD_EXT  Presentation Attack Detection  +---->| 1 |
    |                                             |     +---+
    +---------------------------------------------+ 
....
...
===== FIA_PAD_EXT.1 Biometric data processing
Hierarchical to: No other components

Dependencies: No dependencies

*FIA_PAD_EXT.1.1*:: The TSF shall provide the [*selection*: _biometric modality_] with [*selection*: _enrolment detection_] at biometric enrolment and [*selection*: _verification detection_] at biometric verification.
