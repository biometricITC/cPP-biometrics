...
*Application Note {counter:remark_count}*:: A user enroling to the biometric system will have been authenticated using a NBAF, specified in FIA_UAU.5.1. When any modification of the BAF data occurs, re-authentication shall be performed in accordance with FIA_UAU.6.1.
