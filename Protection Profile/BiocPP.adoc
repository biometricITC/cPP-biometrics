...
*Application Note {counter:remark_count}*:: If the TOE supports multiple modalities, the error rates do not to be identical.

*Application Note {counter:remark_count}*:: If the TOE supports multiple modalities, not all modalities need to define the Evaluation Activities.
...
*Application Note {counter:remark_count}*:: The Consistency Rationale in the appropriate PP-Configuration explains how the TOE in cooperation with its environment protect biometric data in detail.
