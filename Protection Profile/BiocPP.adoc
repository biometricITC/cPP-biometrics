...
===== FTP_TRP.1 Trusted path [[FTP_TRP.1]]

*FTP_TRP.1.1*:: The TSF shall provide a communication path between itself and *local* users that is logically distinct from other communication paths and provides assured identification of its end points and protection of the communicated data from *modification and disclosure by the main computer operating system*.

*FTP_TRP.1.2*:: The TSF shall permit *the TSF* to initiate communication via the trusted path.

*FTP_TRP.1.3*:: The TSF shall require the use of the trusted path for *capturing biometric data*.

*Application Note {counter:remark_count}*:: The trusted path is intended to provide communications between the biometric capture sensor and the SEE.
