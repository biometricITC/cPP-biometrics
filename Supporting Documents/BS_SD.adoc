...
. BMD may be used to provide details about TSFIs that may provide the capbility to export plaintext biometric data but which must be disabled/blocked for use in the evaluated configuration
