...
. The evaluator shall review public papers on biometric quality (see <<Related Documents>> for some referenced quality papers) for the appropriate modality to determine how to create low quality samples if the TOE doesn't show any feedback messages
