...
The developer defines that fingerprint verification consists of 5 attempts using both right index and thumb fingerprints to unlock the computer and specifies FAR not exceeding  0.01% for the upper bound of 95% confidence and FRR not exceeding 4.6% for the upper bound of 80% confidence in FIA_MBV_EXT.1. 
