...
.. The developer tools shall write the biometric template data to an accessible location (either prior or during, depending on the type of test)
.. The evaluator shall perform a biometric transaction
.. The evaluator shall perform a memory scan during the biometric transaction
.. The evaluator shall take a memory scan after the completion of a biometric transaction
.. The evaluator shall confirm that the template data can only be found in memory during the biometric transaction
[loweralpha]
