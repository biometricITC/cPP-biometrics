...
.. The developer shall provide an example of template data (specifically including common header information)
.. The evaluator shall perform a biometric transaction
.. The evaluator shall perform a memory scan prior the biometric transaction
.. The evaluator shall take a memory scan after the completion of a biometric transaction
.. The evaluator shall confirm that the template data (the header information) is not found in the memory scans
[loweralpha]
