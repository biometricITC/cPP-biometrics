...
. All plaintext biometric data is retained in volatile memory within the SEE and any entities outside the SEE including the main computer operating system can’t access these data. No TSFIs exist that reveal plaintext biometric data to any entities outside the SEE
