...
_Bespoke equipment_ refers to very expensive equipment with difficult and controlled access; for example, research printing systems with specific ink definition and flexible support adaptation. In addition, if more than one specialised equipment is required to perform different parts of the attack, this value should be used. This level is restricted to equipment that cannot be obtained through a service, such as renting or accessing a time-limited service for some defined period for the purposes of the attack. If such service exists, the level has to be moved down to Specialised level.
