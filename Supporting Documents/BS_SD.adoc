...
As in the <<CEM>>, the factors to be considered consist of *_Elapsed time_*, *_Expertise_*, *_Knowledge of the TOE_*, *_Equipment_*, *_Window of opportunity_*, and *_Degree of Scutiny_*. But *_Window of opportunity_* is divided into two subfactors *_Window of opportunity (Access to the TOE)_*, *_Window of opportunity (Access to biometric characteristics)_*.
...
Potential difficulties to having access to the TOE in the exploitation environment are taken into account in the factor *_Window of opportunity (Access to the TOE)_* and where applicable, the *_Degree of Scutiny_*, though for mobile devices, this is assumed to be none.
...
[loweralpha]
. _Not needed_: For the attack phase, there is no need to have access to the biometric characteristic.
...
*_Degree of Scrutiny_* refers to the amount of examination or oversight applied during the use of the TOE for authenticaiton. 
...
. _Not practical_: For both the attack and discovery there is a security agent physically present and close to the attacker with thorough control over the TOE during usage. An attack is considered not practical when an attacker is not confident enough to perform an attack, even when an exploit has been found.
