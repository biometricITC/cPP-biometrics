...
However, whole evaluation should be finished within 3 months and PAD testing should be finished within a single week, considering the assurance level claimed by <<BIOPP-Module>>.
