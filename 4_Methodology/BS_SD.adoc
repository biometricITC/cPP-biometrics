...
The main part of EA for FIA_MBV_EXT.3 is evaluator’s testing using artificial PAI. The Section <<Evaluation Activities for FIA_MBV_EXT.3>> defines EAs for ATE_IND.1 and AVA_VAN.1 in detail that the evaluator shall perform during the testing.
...
There is additional application note related to EAs for FIA_MBV_EXT.3 in the Section <<Additional application notes for AGD Class for FIA_MBV_EXT.3>>. The evaluator shall also follow this note depending on the result of the penetration testing for PAD.
...
Same EA should be applied to [BIOcPP Module] except SFR FIA_MBV_EXT.3 (**Presentation attack detection for mobile biometric verification**). The evaluator shall perform EAs defined in the Section <<Evaluation Activities for FIA_MBV_EXT.3>> for FIA_MBV_EXT.3.
