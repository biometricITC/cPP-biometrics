...
However, whole evaluation should be finished within 3 months and independent and penetration testing for PAD functionality should be finished within a single week, considering the assurance level claimed by <<BIOPP-Module>>.
